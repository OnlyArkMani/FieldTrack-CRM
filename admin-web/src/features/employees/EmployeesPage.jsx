...
export default function EmployeesPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Role",
      render: (e) => (
        <span className="text-text-primary">{titleCase(e.role)}</span>
      ),
    },
    {
      key: "team",
    ...
    {
      key: "orders",
      header: "Orders (Target / Captured / Approved)",
      render: (e) => (
        <div className="flex items-center gap-1.5 text-xs whitespace-nowrap">
          ...
          <span className="font-medium text-primary">
            <strong>{e.orders_captured ?? 0}</strong> Captured
          </span>
          <span className="text-border/80">|</span>
          <span className="font-medium text-status-active">
            <strong>{e.orders_approved ?? 0}</strong> Approved
          </span>
        </div>
      ),
    },
